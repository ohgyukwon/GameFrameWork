...
void Collider::update() {
	//for (iter1 = TheGame::Instance()->getGameObjects()->begin(); iter1 != TheGame::Instance()->getGameObjects()->end(); ++iter1) {
	//	for (iter2 = TheGame::Instance()->getGameObjects()->begin(); iter2 != TheGame::Instance()->getGameObjects()->end(); ++iter2) {
	//		if (Collision((*iter1), (*iter2))) {
	//			if ((*iter1)->getTag() == "Bullet" && (*iter2)->getTag() == "Enemy") {
	//				TheGame::Instance()->getGameObjects()->erase(iter1);
	//				iter1 = TheGame::Instance()->getGameObjects()->end();
	//				break;
	//			}
	//		}
	//	}
